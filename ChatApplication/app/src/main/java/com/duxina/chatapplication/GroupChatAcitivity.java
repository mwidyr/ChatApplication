...
public class GroupChatAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == userLogin) {
            ...
            Intent login = new Intent(GroupChatAcitivity.this, LoginActivity.class);
            startActivity(login);
            finish();
        } else {
            // User is already signed in. Therefore, display
            // a welcome Toast
            Toast.makeText(GroupChatAcitivity.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (null == input || "".equalsIgnoreCase(input.getText().toString())) {
                    Toast.makeText(GroupChatAcitivity.this, "Message tidak boleh kosong", Toast.LENGTH_SHORT).show();
                } else {
