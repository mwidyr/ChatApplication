package com.duxina.chatapplication.fragment;
...
import com.duxina.chatapplication.LoginActivity;
import com.duxina.chatapplication.MainActivity;
import com.duxina.chatapplication.R;
import com.duxina.chatapplication.model.UserInformation;
import com.duxina.chatapplication.utils.CustomToast;
...
public class SignUp_Fragment extends Fragment implements OnClickListener {
    ...
    private void saveUserInformation(){
        ...
        String userNameSave = username.getText().toString().trim();

        UserInformation userInformation = new UserInformation(fullNameSave, emailIdSave, mobileNumberSave, locationSave, userNameSave);

        FirebaseUser user = firebaseAuth.getCurrentUser();

        databaseReference.child("USER_DATA").child(user.getUid()).setValue(userInformation);

        databaseReference.child("LIST_USER").child(userNameSave).setValue(user.getUid());
